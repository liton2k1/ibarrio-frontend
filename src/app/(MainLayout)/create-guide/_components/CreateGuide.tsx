...
const CreateGuide = () => {
  ...
  const privateEditUrl = privateGuideId
    ? `${baseUrlEdit}/edit/${privateGuideId}`
    : "";
  ...
  // Create Guide UI
  return (
    <div className="sm:max-w-[652px] mx-auto lg:px-0 px-5 my-20">
      <h1 className="text-3xl font-bold text-center mb-10">
        Create Your Doorstep Page
      </h1>
          ...
          {privateGuideId || publicGuideId ? (
            <div className="flex flex-col gap-6 mt-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-500">
                  Keep this private - use to edit your guide
                </p>
              </div>
            </div>
          ) : (
